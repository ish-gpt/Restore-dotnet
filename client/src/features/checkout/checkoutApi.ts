import { createApi } from "@reduxjs/toolkit/query/react";import { baseQueryWithErrorHandling } from "../../app/api/baseApi";
...
export const checkoutApi = createApi({
    ...
    endpoints:(builder) =>({
        createPaymentIntent: builder.mutation<Basket,void>({
            ...
            onQueryStarted: async(__reactRouterVersion,{dispatch,queryFulfilled}) =>{
                try {
                    ...
                    console.log("Payment intent creating failed", error);
                }
            }
        })
    })
